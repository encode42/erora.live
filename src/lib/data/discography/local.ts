import type { LocalAlbums, LocalTracks } from "$lib/types/discography/local";

export const localAlbums: LocalAlbums = {
	"Momentum Deceived": [
		{
			"title": "Planadaxic",
	...
	"Wisp": [
		{
			"title": "Valley",
			"why":
				"Produced after Continuum, which is featured below, this track was my attempt at polishing my percussion style. I wanted to implement more parts of the drum kit into my patterns, resulting in heavy use of the toms.",
			"startAt": 122.15,
			"endAt": 156.25
		},
		{
		...
		},
		{
			"title": "Equinox",
			"why":
				"I just really like this track. It's likely one of my more unique tracks, featuring a very hollow mixing style. I often mix my tracks to sound very wide and full, causing this one to stick out!",
			"startAt": 106.75,
			"endAt": 169.5
		}
	],
